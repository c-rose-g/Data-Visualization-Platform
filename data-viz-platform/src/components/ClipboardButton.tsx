...
export default function ClipboardButton({onClick, className = ""}:ClipboardButtonProps) {
  return (
   <button type="button" aria-label="clip button" onClick={onClick} className={`${className}`}>
